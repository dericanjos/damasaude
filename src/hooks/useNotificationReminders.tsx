...
const REMINDER_META = [
  { key: 'morning' as const, id: 1001, title: '☀️ Bom dia, Doutor(a)!', body: 'Sua agenda de hoje está pronta. Faça seu check-in no DAMA Clínica.', tag: 'checkin-morning' },
  ...
  const requestPermission = useCallback(async (): Promise<boolean> => {
    if (isNativePlatform()) {
      ...
      if (result.display !== 'granted') {
        toast.error('Permissão negada. Ative as notificações em Ajustes > DAMA Clínica.');
        return false;
      }
      return true;
    }
